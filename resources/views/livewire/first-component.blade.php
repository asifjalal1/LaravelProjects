        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach($users as $user)
                    <tr class="bg-danger border-b dark:bg-gray-800 dark:border-gray-700" wire:key="{{ $user['id'] }}" wire:transition="slide">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a href="#" class="text-white font-medium p-3" wire:click="editUser('{{ $user['id'] ?? null }}')" style="background-color: lightseagreen; padding:5px; border-radius: 6px">Edit</a>
                            <a href="#" class="text-white font-medium p-3" wire:click="deleteUser('{{ $user['id'] ?? null }}')" style="background-color: lightsalmon; padding:5px; border-radius: 6px">delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
